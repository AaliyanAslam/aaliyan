...
const Hero = () => {
  return (
    <div
      className="min-h-screen min-w-420 mx-auto bg-cover bg-center bg-fixed flex flex-col md:flex-row items-center justify-between gap-6 md:gap-10 px-4 md:px-10 py-4 md:py-0"
      style={{
      ...
      <div className="flex-1 text-center md:text-left space-y-4">
        ...
        <div className={`${inter.className}`}>
          ...
          <p className="text-gray-700 text-sm md:text-base max-w-lg mb-12">
            ...
            . I build modern, responsive & high-converting websites and web apps
            with React, Next.js, Node.js & Firebase.
          </p>
          ...
          <div className={`space-y-2 mb-8 `}>
            ...
            <div className="flex items-center gap-3">
              <FaCheck className="text-gray-800 text-xl" />
              <span className="text-gray-900">Solve pain points elegantly</span>
            </div>
            <div className="flex items-center gap-3">
              <FaCheck className="text-gray-800 text-xl" />
