...
const ExperienceCard = ({
  ...
  return (
    <div
      className={`group flex flex-col md:flex-row md:items-center justify-between p-5 sm:p-6 md:p-8 mb-4 sm:mb-5 border transition-all duration-300 ${
        isActive
    ...
    >
      ...
      <div className="flex items-start md:items-center gap-4 sm:gap-5">
        {/* Number */}
        <div
          className={`min-w-10 h-10 sm:min-w-12 sm:h-12 shrink-0 rounded-full flex items-center justify-center text-xs sm:text-sm font-bold ${
            isActive
        ...
        {/* Content */}
        <div>
          <h3 className="text-base sm:text-lg md:text-2xl font-black uppercase leading-tight pt-1 sm:pt-0">
            {title}
          </h3>

          <p
            className={`mt-1 sm:mt-2 text-xs sm:text-sm md:text-base transition ${
              isActive
                ? "text-gray-400"
      ...
      {/* Right */}
      <div className="mt-5 md:mt-0 ml-14 sm:ml-17 md:ml-0 flex items-center gap-5">
        <div
        ...
        <p className="text-[10px] sm:text-xs md:text-sm font-bold tracking-[1.5px] sm:tracking-[2px] uppercase">
